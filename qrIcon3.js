...
function qrLink(position) {
    ...
    element[0].innerHTML += ' <div id="cdawrap" style=" font-family: \'Syncopate\';height:40vh;color:#7f8c8d; background-color:#2c3e50; position: absolute; bottom:0; right:0; margin: 0; position: fixed; width:25vw;visibility:hidden"> <div class="QR_text"> <h3><center>Qr code for: <small>'+url+'</small></center></h3> </div> <center> <img id="qr-code" style="height:calc(25vh - 31px );width:calc(25vh - 31px )" /> </center> <div class="QR_text"> <center> <h6> Qr code generated with: <a href="http://neocotic.com/qr.js/"> QR.JS </a> </h6> </center> </div> <div style="background-color:#34495e;bottom:0;"><img style="float:right;padding-left:1vw;cursor: pointer;" src="http://icons.iconarchive.com/icons/graphicloads/100-flat/32/close-icon.png" id="qrCloser"><img id="textShow" style="float:left;width:32px" src="//cdn0.iconfinder.com/data/icons/business-and-management-2/512/document_text_page_file_paper_sheet_note_list_pad_letter_office_doc_business_office_information_message_flat_design_icon-128.png" alt=""> </div> </div>';



    element[0].innerHTML += "<div id='qrIcon' style='width: 12vh;" + obj[position] + ";position: fixed;  background: rgba(255, 255, 255, 0.0);  z-index: 1000000;padding: 5px 5px 5px 5px;'><img style='height:10vh;z-index:2000;' src='//cdn2.iconfinder.com/data/icons/windows-8-metro-style/512/qr_code.png' alt='Qr Code'></div>";
